...
const TRANSLATIONS = {
  ...
  sv: {
    ...
    strings: {
      ...
      googleCalendarLimitationTitle: 'ℹ️ Google Kalendae Begränsning',
      googleCalendarLimitationBody: 'Redigera händelser är inte supporterat för Google Kalender genom Home Assistant. Du kan ta bort händelser, men för att redigera måste du använda Google Kalender-app eller hemsida...',
      ...
      homeAssistantUnavailable: 'Home Assistant inte tillgängligt',
      googleCalendarEditError: 'Redigera händelser är inte supporterat för Google Kalender genom Home Assistant. Använd Google Kalender-app eller hemsida istället.',
      missingUidError: 'Den här händelsen saknar nödvändig information (UID) och kan inte redigeras',
      calendarNoModifyError: 'Den här kalendern saknar stöd för händelse-ändringar. Försök skapa en ny händelse.',
